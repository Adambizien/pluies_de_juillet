  ...
  if (isAlreadyRegistered) {
    return (
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
        ...
        <p className="text-blue-700 text-sm mt-1">Vous pouvez consulter vos inscriptions dans votre profil.</p>
        <div className="mt-3 space-x-4">
          <a
            href="/planning"
            className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors"
          >
  ...
  if (isCanceled) {
    return (
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
        ...
        <p className="text-yellow-700 text-sm mt-1">Attendez un instant, le bouton de paiement va réapparaître...</p>
      </div>
    );
  }
